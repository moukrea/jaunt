...
for(const entry of await fs.readdir(root,{withFileTypes:true})) {
  ...
  for(const relative of ['resources','jaunt.app/Contents/Resources']) {
    ...
    for(const file of ['web/vendor/meteor.mjs','web/vendor/lucide-all.mjs','web/vendor/LICENSE-meteor.txt','web/vendor/jsqr.mjs','web/vendor/LICENSE-jsQR.txt',...['en','fr','es','it','pt','de'].map(lang=>`web/locales/${lang}.json`)])assert(files.has(file),`Missing bundled resource ${file}`);
