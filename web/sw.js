// precache:begin
const CACHE = 'jaunt-static-eb66024f69967d73';
const STATIC = ["./","./assets/app-icon-192.png","./assets/app-icon-512.png","./assets/favicon.png","./assets/jaunt.png","./index.html","./js/activity.mjs","./js/app.mjs","./js/channels.mjs","./js/crypto.mjs","./js/desktop.mjs","./js/i18n.mjs","./js/icons.mjs","./js/link.mjs","./js/native.mjs","./js/push.mjs","./js/qr.mjs","./js/scrollback.mjs","./js/sha256.mjs","./js/touch-scroll.mjs","./js/transfers.mjs","./js/ui.mjs","./js/vault.mjs","./js/workspace.mjs","./locales/de.json","./locales/en.json","./locales/es.json","./locales/fr.json","./locales/it.json","./locales/pt.json","./manifest.webmanifest","./style.css","./vendor/fonts/jetbrains-mono-latin-400-normal.woff2","./vendor/fonts/jetbrains-mono-latin-700-normal.woff2","./vendor/fonts/jetbrains-mono-latin-ext-400-normal.woff2","./vendor/fonts/jetbrains-mono-latin-ext-700-normal.woff2","./vendor/jetbrains-mono.css","./vendor/jsqr.mjs","./vendor/lucide-all.mjs","./vendor/lucide.mjs","./vendor/meteor.mjs","./vendor/xterm.css","./vendor/xterm.mjs"];
// precache:end
