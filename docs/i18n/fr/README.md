...
| Notifications | Service Android natif optionnel ou Web Push du navigateur ; cloches du terminal, événements de programme, fin de session, test depuis les Réglages et CLI `notify`/`run` |
