...
L'application utilise l'œuvre d'art originale jaunt, des thèmes dark/light/system/circadian, des noms d'hôte/order/defaults et des notifications d'OS privées optionnelles. Elle peut installer/démarrer le service d'hôte et également se connecter à d'autres hôtes.
