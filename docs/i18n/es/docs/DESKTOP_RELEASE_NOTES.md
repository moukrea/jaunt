...
La aplicación utiliza la original obra de arte jaunt, temas oscuros/ligeros/sistema/circadianos, nombres de host/orden/defaults y notificaciones opcionales de sistema operativo privado. Puede instalar/iniciar el servicio de host y también conectarse a otros hosts.
