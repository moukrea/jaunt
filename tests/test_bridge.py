...
def test_setup_edits_are_targeted_and_reversible(tmp_path,monkeypatch):
    ...
    assert after['permissions']['allow']==['Bash(ls)','mcp__jaunt-bridge__jaunt_peers','mcp__jaunt-bridge__jaunt_send','mcp__jaunt-bridge__jaunt_wait_reply','mcp__jaunt-bridge__jaunt_hosts','mcp__jaunt-bridge__jaunt_run','mcp__jaunt-bridge__jaunt_read','mcp__jaunt-bridge__jaunt_shell','mcp__jaunt-bridge__jaunt_sessions','mcp__jaunt-bridge__jaunt_type','mcp__jaunt-bridge__jaunt_output'] and after['enabledPlugins']==original['enabledPlugins']
