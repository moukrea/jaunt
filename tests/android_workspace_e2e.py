...
async def main():
    ...
    try:
        ...
        async with async_playwright() as pw:
            ...
            await page.locator('#new-session-folder').click();await page.get_by_label('Session name').fill('Android fixture');await page.get_by_label('Working directory').fill(str(h.work))
            ...
            await page.locator('#new-session-folder').click();await page.get_by_label('Session name').fill('Other Android tab')
