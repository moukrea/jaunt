...
public final class ClipboardFixture extends Instrumentation {
    ...
    @Override public void onStart(){Bundle result=new Bundle();try{
        ...
        try(InputStream in=context.getAssets().open("jaunt/assets/jaunt.png");OutputStream out=context.getContentResolver().openOutputStream(uri)){byte[] buffer=new byte[4096];int n;while((n=in.read(buffer))!=-1)out.write(buffer,0,n);}
