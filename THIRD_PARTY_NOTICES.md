...
- `web/vendor/xterm.mjs` and `xterm.css`: @xterm/xterm 6.0.0 and @xterm/addon-fit 0.11.0, MIT. Built from the exact package-lock.json dependencies by `npm run prepare-web`; both licenses are preserved in `web/vendor/LICENSE-xterm.txt`.
